...
public class CacheCleanListActivity extends AppCompatActivity implements View.OnClickListener{
        ...
        public void handleMessage(Message msg) {
            switch (msg.what) {
                case SCANNING:
                    ...
                    mRecommend.setText("正在扫描: "+info.packageName);
                    mCanCleanTV.setText("已扫描缓存: "+
                            Formatter.formatFileSize(CacheCleanListActivity.this,cacheMemory));
                    //在主线程添加变化后集合
                    mCacheInfos.clear();
                ...
                case FINISH:
                    ...
                    if (cacheMemory > 0) {
                        ...
                        Toast.makeText(CacheCleanListActivity.this, "您的手机洁净如新", Toast.LENGTH_SHORT).show();
                    }
                    break;
            }
        }
    ...
    private void initView(){
        ...
        mRecommend = (TextView) findViewById(R.id.tb_recommend_clean);
